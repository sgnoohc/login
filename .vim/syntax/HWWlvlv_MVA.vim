...
syn keyword	cType	        TString TH1F TH1 TH1D THStack TTree TFile Bool_t Int_t Float_t Double_t TMatrixD TObject TObjString TObjArray TCanvas TH2F TH2D
syn keyword     cType           TQCompiledCut
syn keyword     cType           TQCutFactory
syn keyword     cType           TQStringUtils
syn keyword     cType           TQUtils
syn keyword     cType           HSG3SampleStyle
syn keyword     cType           HSG3SampleAdder
syn keyword     cType           TQSampleFolder
syn keyword     cType           XSecParserDTO
syn keyword     cType           XSecParser
syn keyword     cType           SampleInitializerDTO
syn keyword     cType           SampleInitializer
syn keyword     cType           CutFactory
syn keyword     cType           CutParameter
syn keyword     cType           CutParameter
