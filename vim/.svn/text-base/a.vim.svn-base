...
call <SID>AddAlternateExtensionMapping('h',"cxx,cpp,c,cc,CC,C")
...
" Mappings between python scripts, shell scripts, log files -- tmhong
call <SID>AddAlternateExtensionMapping('py', 'sh,log')
call <SID>AddAlternateExtensionMapping('sh', 'py,log')
call <SID>AddAlternateExtensionMapping('log', 'sh,py')
" Mappings between css, js, html files -- tmhong
call <SID>AddAlternateExtensionMapping('css', 'js,html')
call <SID>AddAlternateExtensionMapping('js', 'css,html')
call <SID>AddAlternateExtensionMapping('html', 'js,css')

" Setup default search path, unless the user has specified
" a path in their [._]vimrc. 
if (!exists('g:alternateSearchPath'))
"  let g:alternateSearchPath = 'sfr:../Root,sfr:../$basename $(cd ../../; pwd)),sfr:../source,sfr:../src,sfr:../include,sfr:../inc'
  let g:alternateSearchPath = 'sfr:../Root,sfr:../src'
endif
